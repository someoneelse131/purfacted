...
{#if visible}
	<div class="rounded-md border p-4 {colors[type]}" role="alert">
		<div class="flex">
			...
			{#if dismissible}
				<div class="ml-auto pl-3">
					<button
						type="button"
						on:click={dismiss}
						class="-mx-1.5 -my-1.5 inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 hover:bg-opacity-20 hover:bg-gray-500"
					>
